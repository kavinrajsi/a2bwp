...
?>
      ...
      <div class="coe__box">
        <div class="col-box">
          ...
          <p class="text-center">As part of our thought leadership and pursuit of excellence, we are working to create a CoE in Chennai. This initiative will bring together talent from across domains in the food industry in a hi-tech space.</p>
